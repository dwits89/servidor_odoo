...
modules_to_install = [
    ...
    'base_import', 'base_install_request', 'base_location', 'base_location_geonames_import', 'base_partner_sequence', 
    'base_setup', 'base_sparse_field', 'base_technical_features', 'base_vat', 'bus', 'calendar_sms', 'contract', 
    'contract_payment_mode', 'crm_iap_enrich', 'crm_iap_mine', 'crm_sms', 'date_range', 'date_range_account', 
    'digest', 'disable_odoo_online', 'document_url', 'gamification_sale_crm', 'iap', 'iap_crm', 'iap_mail', 'l10n_es', 
    'l10n_es_account_asset', 'l10n_es_account_statement_import_n43', 'l10n_es_aeat', 'l10n_es_aeat_mod115', 
    'l10n_es_aeat_mod123', 'l10n_es_aeat_mod303', 'l10n_es_aeat_mod347', 'l10n_es_aeat_mod349', 'l10n_es_aeat_mod390', 
    'l10n_es_aeat_partner_check', 'l10n_es_dua', 'l10n_es_mis_report', 'l10n_es_toponyms', 
    'l10n_es_vat_book', 'link_tracker', 'mail_bot', 'mass_mailing_crm', 'mass_mailing_sale', 
    'mis_builder_budget', 'partner_autocomplete', 'partner_manual_rank', 'payment', 'portal_rating', 'privacy_lookup', 
    'product', 'rating', 'remove_odoo_enterprise', 'report_xlsx', 'report_xlsx_helper', 'resource', 'sale', 'sale_crm', 
    'sale_product_configurator', 'sale_product_template_tags', 'sale_sms', 'sales_team', 'server_action_mass_edit', 
    'show_db_name', 'sms', 'snailmail', 'snailmail_account', 'social_media', 'spreadsheet', 'spreadsheet_account', 
    'spreadsheet_dashboard', 'spreadsheet_dashboard_account', 'spreadsheet_dashboard_sale', 'uom', 'utm', 'web', 
    'web_editor', 'web_kanban_gauge', 'web_no_bubble', 'web_timeline', 'web_tour', 'web_unsplash', 'mass_mailing_themes', 
