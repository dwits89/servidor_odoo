...
modules_to_install = [
    ...
    'report_xml', 'resource', 'sale_product_configurator', 'sale_product_template_tags', 'sale_sms', 'sales_team', 
    'server_action_mass_edit', 'show_db_name', 'sms', 'snailmail', 'snailmail_account', 'social_media', 'spreadsheet', 
    'spreadsheet_account', 'spreadsheet_dashboard', 'spreadsheet_dashboard_sale', 'uom', 'utm', 'web', 'web_editor', 
    'web_kanban_gauge', 'web_no_bubble', 'web_timeline', 'web_tour', 'web_unsplash', 'gamification', 'portal', 
    'http_routing', 'phone_validation', 'crm', 'mass_mailing', 'mis_builder', 'calendar', 'note', 'calendar_sms', 
    'crm_iap_enrich', 'crm_iap_mine', 'crm_sms', 'gamification_sale_crm', 'iap_crm', 'l10n_es_mis_report', 'link_tracker', 
    'mass_mailing_crm', 'mass_mailing_sale', 'mis_builder_budget', 'sale_crm', 'spreadsheet_dashboard_account', 
    'mass_mailing_themes', 'board'
]
