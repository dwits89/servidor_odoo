...
modules_to_install = [
    'sale_management', 'account', 'stock', 'purchase', 'project', 'mass_mailing', 'hr_expense', 'hr_holidays', 'hr', 
    'account_financial_report', 'document_knowledge', 'mis_builder', 'mail', 'contacts', 'calendar', 'survey', 
    'hr_attendance', 'note', 'hr_contract', 'web_responsive', 'purchase_price_diff', 'base_address_extended', 
    'purchase_stock', 'account_asset_management', 'account_banking_mandate', 'account_chart_update', 
    ...
    'account_payment_partner', 'account_payment_purchase', 'account_payment_purchase_stock', 
    'account_payment_sale', 'account_payment_term_extension', 'account_qr_code_sepa', 'account_reconcile_oca', 
    ...
    'calendar_sms', 'contract', 'contract_payment_mode', 'date_range', 'date_range_account', 'digest', 
    'disable_odoo_online', 'document_page', 'document_page_approval', 'document_page_group', 'document_page_tag', 
    'document_url', 'google_gmail', 'hr_gamification', 'hr_holidays_attendance', 'hr_org_chart', 'iap', 'iap_mail', 
    ...
    'mail_bot', 'mail_bot_hr', 'mass_mailing_sale', 'mis_builder_budget', 'partner_autocomplete', 
    'partner_firstname', 'partner_manual_rank', 'payment', 'portal_rating', 'privacy_lookup', 'product', 
    'project_hr_expense', 'project_purchase', 'project_sale_expense', 'project_sms', 'project_task_add_very_high', 
    'project_task_default_stage', 'project_timeline', 'rating', 'remove_odoo_enterprise', 'report_qweb_parameter', 
    'report_xlsx', 'report_xlsx_helper', 'report_xml', 'resource', 'sale_expense', 'sale_product_configurator', 
    'sale_product_template_tags', 'sale_project', 'sale_project_stock', 'sale_purchase', 'sale_purchase_stock', 
    'sale_sms', 'sale_stock', 'sales_team', 'server_action_mass_edit', 'show_db_name', 'sms', 'snailmail', 
    'snailmail_account', 'social_media', 'spreadsheet', 'spreadsheet_account', 'spreadsheet_dashboard', 
    'spreadsheet_dashboard_account', 'spreadsheet_dashboard_hr_expense', 'spreadsheet_dashboard_purchase', 
    'spreadsheet_dashboard_sale', 'spreadsheet_dashboard_sale_expense', 'spreadsheet_dashboard_stock_account', 
    'stock_sms', 'uom', 'utm', 'web', 'web_editor', 'web_kanban_gauge', 'web_no_bubble', 'web_timeline', 
    'web_tour', 'web_unsplash', 'mass_mailing_themes', 'gamification', 'board', 'portal', 'http_routing', 
    'phone_validation', 'product_margin'
]
